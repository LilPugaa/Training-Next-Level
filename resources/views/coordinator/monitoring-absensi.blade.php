                ...
                <table class="min-w-full rounded-xl overflow-hidden">
                    ...
                    <tbody class="divide-y divide-gray-200 text-sm">
                        <tr class="hover:bg-gray-50 transition text-left">
                            ...
                            <td class="px-4 py-3">
                                <div
                                    class="px-2 py-1 w-fit text-xs uppercase font-medium rounded-full gap-2 bg-orange-100 text-[#FF4D00]">
                                    <p>Check-In</p>
                                </div>
                            </td>
                        ...
                        <tr class="hover:bg-gray-50 transition text-left">
                            ...
                            <td class="px-4 py-3">
                                <div
                                    class="px-2 py-1 w-fit text-xs uppercase font-medium rounded-full gap-2 bg-green-100 text-[#10AF13]">
                                    <p>Validated</p>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-center">
                        ...
                        <tr class="hover:bg-gray-50 transition text-left">
                            ...
                            <td class="px-4 py-3">
                                <div
                                    class="px-2 py-1 w-fit text-xs uppercase font-medium rounded-full gap-2 bg-gray-200 text-gray-700">
                                    <p>Belum Absen</p>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-center">
                        ...
                        <tr class="hover:bg-gray-50 transition text-left">
                            ...
                            <td class="px-4 py-3">
                                <div
                                    class="px-2 py-1 w-fit text-xs uppercase font-medium rounded-full gap-2 bg-red-100 text-[#ff0000]">
                                    <p>Absent</p>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-center">
