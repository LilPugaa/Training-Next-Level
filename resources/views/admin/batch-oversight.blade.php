    ...
    <div class="grid gap-6 mt-8 px-2">
        <div class="bg-white border rounded-2xl p-6">
            <div class="flex items-center justify-between position-relative w-full mb-5">
                ...
                <div class="flex items-center bg-white border rounded-lg px-3 gap-3 py-1 w-fit cursor-pointer hover:bg-gray-50 transitionn font-semibold">
            ...
            <div class="overflow-x-auto" x-data="{ openDetail: false }">
                ...
                <!-- Modal Detail -->
                <div x-show="openDetail" x-cloak x-transition id="detailBatch" class="fixed inset-0 bg-black/40 z-50 items-center flex justify-center">
                    <div @click.outside="openDetail = false" class="bg-white max-w-xl rounded-2xl shadow-lg p-8 relative">

                        <!-- Close Button -->
                        <button @click="openDetail = false" class="absolute top-6 right-6 text-[#737373] hover:text-black text-xl">
