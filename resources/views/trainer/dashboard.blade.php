...
@section('content')
    ...
    <div class="bg-white border rounded-2xl p-6 mt-8 mx-2">
        ...
        <div class="space-y-4 max-h-[540px] overflow-y-auto pr-1">
                ...
                <div class="flex items-center justify-between p-4 border rounded-xl hover:bg-gray-50 transition">
                    <div>
                        ...
                        <p class="text-md font-medium text-[#737373] flex flex-wrap gap-2">
                            ...
                            <span>•</span>
                            <span>{{ $batch->participants_count ?? 0 }} peserta</span>
                        </p>
                    </div>
            ...
            @empty
                <div
                    class="p-11 border border-dashed rounded-2xl bg-gray-50 transition grid-cols-1 lg:grid-cols-2 mt-8 mx-2">
                    ...
                    <div class="flex justify-center mb-2">
                        <p class="text-md font-medium text-gray-700">
                            Tidak ada batch yang ditugaskan.
                        </p>
                    </div>
                </div>
            @endforelse
